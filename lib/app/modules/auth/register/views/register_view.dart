                          ...
                          Container(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                        padding: getPadding(top: 9, bottom: 19),
                                        child: RichText(
...
class SignupItemWidget extends StatefulWidget {
  SignupItemWidget({required this.index});
  final int index;

  @override
  State<SignupItemWidget> createState() => _SignupItemWidgetState();
}

class _SignupItemWidgetState extends State<SignupItemWidget> {
                  ...
                  ? Obx(() => TextField(
                        ...
                        decoration: InputDecoration(
                          suffixIcon: Icon(
                            ...
                            color:
                                email.value ? Colors.green : Colors.grey[400],
                          ),
                          prefixIcon: Icon(
                            Icons.mail_outlined,
                            color: Colors.grey[400],
                          ...
                          hintStyle: GoogleFonts.poppins(
                              textStyle: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w400)),
                          contentPadding:
                              EdgeInsets.fromLTRB(5.0, 20.0, 20.0, 10.0),
                          border: InputBorder.none,
                        ),
                      ))
                  : TextField(
